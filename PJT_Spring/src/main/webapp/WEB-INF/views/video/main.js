...
videoList1.forEach((video)=> {
    videoHtml1 += `
    <iframe width="450" height="200" src="https://www.youtube.com/embed/${video.id}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    `
})
...
document.querySelector("#video-area1").innerHTML = videoHtml1
