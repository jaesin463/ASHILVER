...
<body style="margin: 0px 350px;">
	...
	<!-- 리뷰수정 -->
		...
		글쓴이<br>
		<input type="text" class="form-control" name="writer" value="${Review.writer }" readonly>
		내용<br>
		<textarea rows="3" style="height: 350px;" class="form-control" name="content">${Review.content }
		</textarea>
		<br>
