...
<body style="margin: 0px 350px;">
	...
	<form action="/join" method="POST">
		...
		<div class="form-floating mb-3" style="margin: 10px 0px;">
		...
		<div class="form-floating" style="margin: 10px 0px;">
			<input type="password" class="form-control" id="floatingPassword"
				placeholder="Password" name="checkpassword"> <label
				for="floatingPassword">비밀번호 확인</label>
		</div>
		<button class="btn btn-primary"
			style="background-color: #1e90ff; margin-left: 7px; width: 200px;">가입</button>
	</form>
